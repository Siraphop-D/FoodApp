...
class CleanfoodScreen extends StatefulWidget {
  const CleanfoodScreen({super.key});

  @override
  State<CleanfoodScreen> createState() => _CleanfoodScreenState();
}

class _CleanfoodScreenState extends State<CleanfoodScreen> {
