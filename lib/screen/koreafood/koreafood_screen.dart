...
class KoreafoodScreen extends StatefulWidget {
  const KoreafoodScreen({super.key});

  @override
  State<KoreafoodScreen> createState() => _KoreafoodScreenState();
}

class _KoreafoodScreenState extends State<KoreafoodScreen> {
